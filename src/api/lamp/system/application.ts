import { ApplicationSaveDTO, ApplicationUpdateDTO, Application, ApplicationPageQuery } from './model/applicationModel';
...
export const query = (params: Application) => defHttp.request<Application[]>({ ...Api.Query, params });

export const save = (params: ApplicationSaveDTO) => defHttp.request<Application>({ ...Api.Save, params });
