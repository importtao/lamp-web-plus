import { ParameterSaveDTO, ParameterUpdateDTO, Parameter, ParameterPageQuery } from './model/parameterModel';
...
export const save = (params: ParameterSaveDTO) => defHttp.request<Parameter>({ ...Api.Save, params });
