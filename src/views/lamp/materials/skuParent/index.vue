...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/skuParent';
  import { columns, searchFormSchema } from './skuParent.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'SkuParentManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.skuParent.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
