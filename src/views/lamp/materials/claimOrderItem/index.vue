...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/claimOrderItem';
  import { columns, searchFormSchema } from './claimOrderItem.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'ClaimOrderItemManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.claimOrderItem.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
