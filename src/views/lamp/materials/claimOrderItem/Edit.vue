...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/lamp/materials/claimOrderItem';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './claimOrderItem.data';

  export default defineComponent({
    name: 'ClaimOrderItemEdit',
