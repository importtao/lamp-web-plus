...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/categoryField';
  import { columns, searchFormSchema } from './categoryField.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'CategoryFieldManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.categoryField.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
