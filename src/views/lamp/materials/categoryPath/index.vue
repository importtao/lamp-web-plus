...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/categoryPath';
  import { columns, searchFormSchema } from './categoryPath.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'CategoryPathManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.categoryPath.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
