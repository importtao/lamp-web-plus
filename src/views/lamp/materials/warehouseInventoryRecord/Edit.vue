...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/lamp/materials/warehouseInventoryRecord';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './warehouseInventoryRecord.data';

  export default defineComponent({
    name: 'WarehouseInventoryRecordEdit',
