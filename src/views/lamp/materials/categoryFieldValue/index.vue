...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/categoryFieldValue';
  import { columns, searchFormSchema } from './categoryFieldValue.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'CategoryFieldValueManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.categoryFieldValue.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
