...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/lamp/materials/categoryFieldValue';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './categoryFieldValue.data';

  export default defineComponent({
    name: 'CategoryFieldValueEdit',
