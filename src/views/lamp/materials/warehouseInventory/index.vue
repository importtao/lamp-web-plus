...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/warehouseInventory';
  import { columns, searchFormSchema } from './warehouseInventory.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'WarehouseInventoryManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.warehouseInventory.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
