...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/useOrg';
  import { columns, searchFormSchema } from './useOrg.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'UseOrgManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.useOrg.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
