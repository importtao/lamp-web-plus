...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/skuItem';
  import { columns, searchFormSchema } from './skuItem.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'SkuItemManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.skuItem.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
