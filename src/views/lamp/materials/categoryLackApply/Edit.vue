...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/lamp/materials/categoryLackApply';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './categoryLackApply.data';

  export default defineComponent({
    name: 'CategoryLackApplyEdit',
