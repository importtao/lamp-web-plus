...
<script lang="ts">
  ...
  import { page, remove } from '/@/api/lamp/materials/claimOrder';
  import { columns, searchFormSchema } from './claimOrder.data';
  import EditModal from './Edit.vue';

  export default defineComponent({
    name: 'ClaimOrderManagement',
    ...
    setup() {
      ...
      const [registerTable, { reload, getSelectRowKeys }] = useTable({
        title: t('lamp.materials.claimOrder.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
