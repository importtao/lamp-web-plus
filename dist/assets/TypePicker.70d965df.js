import{d as c,aZ as d,g as s,aW as f,aX as u,r as m,o as t,n as i,M as v,aE as l,p as a,aF as _}from"./index.b361f078.js";import"./vendor.352e3120.js";var r=c({name:"MenuTypePicker",components:{Tooltip:d},props:{menuTypeList:{type:Array,defualt:()=>[]},handler:{type:Function,default:()=>{}},def:{type:String,default:""}},setup(){const{prefixCls:e}=s("setting-menu-type-picker");return{prefixCls:e}}}),I=`.vben-setting-menu-type-picker[data-v-c5cf2698] {
  display: flex;
}
