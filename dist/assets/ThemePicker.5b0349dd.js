import{d,bw as l,g as c,r as m,o as t,n as i,M as f,aE as u,p as v}from"./index.b6dfbfcf.js";import{b as _}from"./index.c130f86a.js";import"./vendor.352e3120.js";import"./useDrawer.3628b9ed.js";import"./ArrowLeftOutlined.7dae0225.js";import"./index.8c7a9c9a.js";import"./index.57ea38db.js";var p=d({name:"ThemePicker",components:{CheckOutlined:l},props:{colorList:{type:Array,defualt:[]},event:{type:Number,default:()=>{}},def:{type:String}},setup(e){const{prefixCls:r}=c("setting-theme-picker");function s(a){e.event&&_(e.event,a)}return{prefixCls:r,handleClick:s}}}),O=`.vben-setting-theme-picker {
  display: flex;
  flex-wrap: wrap;
  margin: 16px 0;
