import{d,bw as l,g as c,r as m,o as t,n as i,M as f,aE as u,p as v}from"./index.f012a3f4.js";import{b as _}from"./index.21e8ef7b.js";import"./vendor.352e3120.js";import"./useDrawer.803df328.js";import"./ArrowLeftOutlined.61d94bda.js";import"./index.a9d5c22c.js";import"./index.a99c15a9.js";var p=d({name:"ThemePicker",components:{CheckOutlined:l},props:{colorList:{type:Array,defualt:[]},event:{type:Number,default:()=>{}},def:{type:String}},setup(e){const{prefixCls:r}=c("setting-theme-picker");function s(a){e.event&&_(e.event,a)}return{prefixCls:r,handleClick:s}}}),O=`.vben-setting-theme-picker {
  display: flex;
  flex-wrap: wrap;
  margin: 16px 0;
