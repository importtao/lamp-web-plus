var b=Object.assign;import{j as M,aC as i,d as L,g as V,k as g,r as k,o as w,n as h,M as ae,aG as v,s as P,J as C,L as j,q as T,N as B,cY as ie,p as y,a$ as le,w as _,bY as de,ci as q,D as a,E as O,c4 as ce,ap as z,ae as ue,aK as I,aB as G,V as Y,cX as pe,aD as x,G as fe,aE as be,y as J,aA as K,cj as ge,aw as we,ch as H}from"./index.b7a14d4f.js";import{A as he}from"./ArrowLeftOutlined.70d092e9.js";import{D as ve}from"./index.33bf2bdd.js";const{t:U}=M(),W={confirmLoading:i.bool,showCancelBtn:i.bool.def(!0),cancelButtonProps:Object,cancelText:i.string.def(U("common.cancelText")),showOkBtn:i.bool.def(!0),okButtonProps:Object,okText:i.string.def(U("common.okText")),okType:i.string.def("primary"),showFooter:i.bool,footerHeight:{type:[String,Number],default:60}},me=b({isDetail:i.bool,title:i.string.def(""),loadingText:i.string,showDetailBack:i.bool.def(!0),visible:i.bool,loading:i.bool,maskClosable:i.bool.def(!0),getContainer:{type:[Object,String]},scrollOptions:{type:Object,default:null},closeFunc:{type:[Function,Object],default:null},triggerWindowResize:i.bool,destroyOnClose:i.bool},W);var X=L({name:"BasicDrawerFooter",props:b(b({},W),{height:{type:String,default:"60px"}}),emits:["ok","close"],setup(e,{emit:s}){const{prefixCls:t}=V("basic-drawer-footer"),d=g(()=>{const n=`${e.height}`;return{height:n,lineHeight:n}});function l(){s("ok")}function u(){s("close")}return{handleOk:l,prefixCls:t,handleClose:u,getStyle:d}}}),Fe=`.vben-basic-drawer-footer {
  position: absolute;
  bottom: 0;
  width: 100%;
...
}`;function _e(e,s,t,d,l,u){const n=k("DrawerHeader"),r=k("ScrollContainer"),c=k("DrawerFooter"),f=k("Drawer"),D=pe("loading");return w(),h(f,P({class:e.prefixCls,onClose:e.onClose},e.getBindValues),x({default:C(()=>[fe(y(r,{style:e.getScrollContentStyle,"loading-tip":e.loadingText||e.t("common.loadingText")},{default:C(()=>[v(e.$slots,"default")]),_:3},8,["style","loading-tip"]),[[D,e.getLoading]]),y(c,P(e.getProps,{onClose:e.onClose,onOk:e.handleOk,height:e.getFooterHeight}),x({_:2},[be(Object.keys(e.$slots),m=>({name:m,fn:C(F=>[v(e.$slots,m,F)])}))]),1040,["onClose","onOk","height"])]),_:2},[e.$slots.title?void 0:{name:"title",fn:C(()=>[y(n,{title:e.getMergeProps.title,isDetail:e.isDetail,showDetailBack:e.showDetailBack,onClose:e.onClose},{titleToolbar:C(()=>[v(e.$slots,"titleToolbar")]),_:1},8,["title","isDetail","showDetailBack","onClose"])])}]),1040,["class","onClose"])}Z.render=_e;const $=J({}),R=J({});function ye(){const e=_(null),s=_(!1),t=_("");function d(n,r){K(()=>{e.value=null,s.value=null,$[a(t)]=null}),!(a(s)&&ge()&&n===a(e))&&(t.value=r,e.value=n,s.value=!0,n.emitVisible=(c,f)=>{R[f]=c})}const l=()=>{const n=a(e);return n||H("useDrawer instance is undefined!"),n},u={setDrawerProps:n=>{var r;(r=l())==null||r.setDrawerProps(n)},getVisible:g(()=>R[~~a(t)]),openDrawer:(n=!0,r,c=!0)=>{var D;if((D=l())==null||D.setDrawerProps({visible:n}),!r)return;if(c){$[a(t)]=null,$[a(t)]=O(r);return}we(O($[a(t)]),O(r))||($[a(t)]=O(r))}};return[d,u]}const $e=e=>{const s=_(null),t=I(),d=_("");t||H("useDrawerInner instance is undefined!");const l=()=>{const n=a(s);if(!n){H("useDrawerInner instance is undefined!");return}return n},u=(n,r)=>{K(()=>{s.value=null}),d.value=r,s.value=n,t==null||t.emit("register",n,r)};return z(()=>{const n=$[a(d)];!n||!e||!G(e)||Y(()=>{e(n)})}),[u,{changeLoading:(n=!0)=>{var r;(r=l())==null||r.setDrawerProps({loading:n})},changeOkLoading:(n=!0)=>{var r;(r=l())==null||r.setDrawerProps({confirmLoading:n})},getVisible:g(()=>R[~~a(d)]),closeDrawer:()=>{var n;(n=l())==null||n.setDrawerProps({visible:!1})},setDrawerProps:n=>{var r;(r=l())==null||r.setDrawerProps(n)}}]};export{Z as _,$e as a,ye as u};
