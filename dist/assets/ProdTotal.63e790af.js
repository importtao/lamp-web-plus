import{w as c}from"./data.aa527d47.js";import{d as v,r as d,o as t,n as o,M as u,aE as g,p as n,q as p,aF as f}from"./index.05ea33df.js";import{R as i,C as l}from"./index.48bbff73.js";import"./vendor.352e3120.js";import"./Col.8bf95754.js";import"./responsiveObserve.968aa5d0.js";import"./canUseDom.0bf35682.js";var e=v({components:{[i.name]:i,[l.name]:l},setup(){return{wokbProd:c}}}),A=`.prod-total[data-v-72749e4b] {
...
.prod-total__item-3 div[data-v-72749e4b] {
  color: #00c4ba;
}`;const r=f(),x=r((s,k,S,h,w,E)=>{const m=d("a-col"),b=d("a-row");return t(),o(b,{class:"prod-total"},{default:r(()=>[(t(!0),o(u,null,g(s.wokbProd,(a,_)=>(t(),o(m,{key:a.type,xs:12,sm:6,class:["prod-total__item",`prod-total__item-${_}`]},{default:r(()=>[n("div",{class:["img",`prod-total__item-${_}-img`]},null,2),n("div",null,p(a.amount),1),n("span",null,p(a.type),1)]),_:2},1032,["class"]))),128))]),_:1})});e.render=x,e.__scopeId="data-v-72749e4b";export default e;
