import{d as v,b7 as _,aC as w,w as o,g as b,k as S,D as r,x as y,dd as x,V as $,r as k,o as C,n as H,p as g,aF as W}from"./index.ff8e7350.js";import{u as z}from"./useWindowSizeFn.dd41c952.js";import"./vendor.352e3120.js";var d=v({name:"IFrame",components:{Spin:_},props:{frameSrc:w.string.def("")},setup(){const e=o(!1),p=o(50),s=o(window.innerHeight),a=o(null),{prefixCls:f}=b("iframe-page");z(i,150,{immediate:!0});const l=S(()=>({height:`${r(s)}px`}));function i(){const n=r(a);if(!n)return;let{top:t}=x(n);t+=20,p.value=t,s.value=window.innerHeight-t;const h=document.documentElement.clientHeight-t;n.style.height=`${h}px`}function c(){e.value=!1,i()}function u(){$(()=>{const n=r(a);if(!n)return;const t=n;t.attachEvent?t.attachEvent("onload",()=>{c()}):n.onload=()=>{c()}})}return y(()=>{e.value=!0,u()}),{getWrapStyle:l,loading:e,frameRef:a,prefixCls:f}}}),E=`.vben-iframe-page .ant-spin-nested-loading[data-v-10f18273] {
  position: relative;
  height: 100%;
}
